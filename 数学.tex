...
\end{gather*}
\subsubsection*{10.一次函数}
\begin{gather*}
\text{形如$y=kx+b$（$k, b$是常数，$k\neq0$）的函数叫做一次函数。} \\
\text{形如$y=kx$（$k$是常数，$k\neq0$）的函数叫做正比例函数。} \\
\text{一般的，正比例函数$y=kx$（$k$是常数，$k\neq0$）具有以下性质：} \\
\text{当$k>0$时，$y$随$x$的增大而增大；} \\
\text{当$k<0$时，$y$随着$x$的增大而减小。} \\
\text{一般的，一次函数$y=kx+b$（$k, b$是常数，$k\neq0$）具有以下性质：} \\
\text{当$k>0$时，$y$随着$x$的增大而增大；} \\
\text{当$k<0$时，$y$随着$x$的增大而减小。}
\end{gather*}
\subsubsection*{11.一元二次方程}
\begin{gather*}
